...
namespace Equibles.Stocks.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = Equibles.Stocks.Client.Configuration.Default;
            RestClient = new RestClient("https://api.equibles.com");
            RestClient.IgnoreResponseStatusCode = true;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://api.equibles.com).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? Equibles.Stocks.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://api.equibles.com")
        {
