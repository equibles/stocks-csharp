...
namespace Equibles.Stocks.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CurrenciesResponse :  IEquatable<CurrenciesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CurrenciesResponse" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public CurrenciesResponse(ResponseStatus status = default(ResponseStatus))
        {
            this.Status = status;
        }
        ...
        public List<Currency> Results { get; private set; }
