...
namespace Equibles.Stocks.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ExchangesResponse :  IEquatable<ExchangesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangesResponse" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public ExchangesResponse(ResponseStatus status = default(ResponseStatus))
        {
            this.Status = status;
        }
        ...
        public List<Exchange> Results { get; private set; }
