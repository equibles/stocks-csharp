...
namespace Equibles.Stocks.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class FinancialAssetsResponse :  IEquatable<FinancialAssetsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FinancialAssetsResponse" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public FinancialAssetsResponse(ResponseStatus status = default(ResponseStatus))
        {
            this.Status = status;
        }
        ...
        {
            return this.Equals(input as FinancialAssetsResponse);
        }

        /// <summary>
        /// Returns true if FinancialAssetsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of FinancialAssetsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FinancialAssetsResponse input)
        {
            if (input == null)
                return false;
