...
namespace Equibles.Stocks.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class FundamentalsResponse :  IEquatable<FundamentalsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FundamentalsResponse" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public FundamentalsResponse(ResponseStatus status = default(ResponseStatus))
        {
            this.Status = status;
        }
        ...
        public List<FinancialReport> Results { get; private set; }
