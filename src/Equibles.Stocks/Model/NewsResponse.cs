...
namespace Equibles.Stocks.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class NewsResponse :  IEquatable<NewsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewsResponse" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public NewsResponse(ResponseStatus status = default(ResponseStatus))
        {
            this.Status = status;
        }
        ...
        public List<News> Results { get; private set; }
        ...
        {
            return this.Equals(input as NewsResponse);
        }

        /// <summary>
        /// Returns true if NewsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of NewsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewsResponse input)
        {
            if (input == null)
                return false;
