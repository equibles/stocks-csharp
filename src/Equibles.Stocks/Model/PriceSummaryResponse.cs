...
namespace Equibles.Stocks.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PriceSummaryResponse :  IEquatable<PriceSummaryResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceSummaryResponse" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        /// <param name="results">results.</param>
        public PriceSummaryResponse(ResponseStatus status = default(ResponseStatus), PriceSummary results = default(PriceSummary))
        {
            this.Status = status;
        ...
        public PriceSummary Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PriceSummaryResponse {\n");
        ...
        {
            return this.Equals(input as PriceSummaryResponse);
        }

        /// <summary>
        /// Returns true if PriceSummaryResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceSummaryResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceSummaryResponse input)
        {
            if (input == null)
                return false;
