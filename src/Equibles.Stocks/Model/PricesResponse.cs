...
namespace Equibles.Stocks.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PricesResponse :  IEquatable<PricesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PricesResponse" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public PricesResponse(ResponseStatus status = default(ResponseStatus))
        {
            this.Status = status;
        }
        ...
        public List<Price> Results { get; private set; }
