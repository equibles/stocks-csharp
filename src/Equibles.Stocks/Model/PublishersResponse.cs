...
namespace Equibles.Stocks.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PublishersResponse :  IEquatable<PublishersResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublishersResponse" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public PublishersResponse(ResponseStatus status = default(ResponseStatus))
        {
            this.Status = status;
        }
        ...
        public List<Publisher> Results { get; private set; }
        ...
        {
            return this.Equals(input as PublishersResponse);
        }

        /// <summary>
        /// Returns true if PublishersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PublishersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PublishersResponse input)
        {
            if (input == null)
                return false;
