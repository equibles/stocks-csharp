...
namespace Equibles.Stocks.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SectorsResponse :  IEquatable<SectorsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SectorsResponse" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public SectorsResponse(ResponseStatus status = default(ResponseStatus))
        {
            this.Status = status;
        }
        ...
        public List<Sector> Results { get; private set; }
        ...
        {
            return this.Equals(input as SectorsResponse);
        }

        /// <summary>
        /// Returns true if SectorsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SectorsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SectorsResponse input)
        {
            if (input == null)
                return false;
