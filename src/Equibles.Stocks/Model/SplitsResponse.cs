...
namespace Equibles.Stocks.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SplitsResponse :  IEquatable<SplitsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SplitsResponse" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public SplitsResponse(ResponseStatus status = default(ResponseStatus))
        {
            this.Status = status;
        }
        ...
        public List<StockSplit> Results { get; private set; }
