...
namespace Equibles.Stocks.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class StockProfileResponse :  IEquatable<StockProfileResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StockProfileResponse" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        /// <param name="results">results.</param>
        public StockProfileResponse(ResponseStatus status = default(ResponseStatus), StockProfile results = default(StockProfile))
        {
            this.Status = status;
        ...
        public StockProfile Results { get; set; }
        ...
        {
            return this.Equals(input as StockProfileResponse);
        }

        /// <summary>
        /// Returns true if StockProfileResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of StockProfileResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StockProfileResponse input)
        {
            if (input == null)
                return false;
