...
namespace Equibles.Stocks.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class StockProfilesResponse :  IEquatable<StockProfilesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StockProfilesResponse" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public StockProfilesResponse(ResponseStatus status = default(ResponseStatus))
        {
            this.Status = status;
        }
        ...
        public List<StockProfile> Results { get; private set; }
        ...
        {
            return this.Equals(input as StockProfilesResponse);
        }

        /// <summary>
        /// Returns true if StockProfilesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of StockProfilesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StockProfilesResponse input)
        {
            if (input == null)
                return false;
